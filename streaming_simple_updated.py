...
class StdOutListener(StreamListener):
	...
	def on_data(self, data):
		...
		text_encoded = text.encode('utf8', 'replace') # This line makes any weird characters in the venue name printable for the next line

		print(text_encoded) #Print it out
...
if __name__ == '__main__':
	try:
		...
		fhOut = open("/Users/EvanSweet/Desktop/Advanced GIS/twitter-python-master/output.json", "a")
		...
		#Terms to track
		stream.filter(track=["wine","beer","bourbon"])
